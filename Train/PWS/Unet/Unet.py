...
OUTPUT_DIR = r"F:\Sample9\PythonProject\PWS\Unet\output_model3"  # Output directory
...
class CombinedLoss(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        foreground_pred = torch.softmax(outputs, dim=1)[:, 1, :, :]
...
def visualize_predictions(model, test_slice_files, test_label_files, device, num_samples=3):
    ...
    plt.close()
    print("Prediction visualization completed, images saved.")
