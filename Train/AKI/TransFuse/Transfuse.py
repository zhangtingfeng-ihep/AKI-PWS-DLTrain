...
OUTPUT_DIR = r"F:\Sample9\TransFuse\Model_Output4"
...
class TransFuse_S(nn.Module):
    def __init__(self, num_classes=3, drop_rate=0.2, pretrained=False):
